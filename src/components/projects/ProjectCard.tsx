...
function ProjectCard({ project }: { project: projects }) {
  return (
    <Link
      ...
      className="rounded-ss-lg bg-black/25 rounded-ee-lg blur-bg border border-primary-border-color cursor-pointer flex flex-col mb-5 max-w-[30rem] sm:max-w-[26rem] mx-auto"
