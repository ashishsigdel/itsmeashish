...
export default function TechBehind() {
  ...
  return (
    <div className="flex flex-col justify-center  my-3 px-3 mx-auto min-h-[100vh-96px]">
      ...
      <motion.div
        ref={ref}
        className="bg-white dark:bg-black text-hard-dark/80 dark:text-light/80 rounded-ss-md rounded-ee-md blur-bg dark:text-gray-300 border border-black/15 dark:border-white/15 max-w-4xl mx-auto"
