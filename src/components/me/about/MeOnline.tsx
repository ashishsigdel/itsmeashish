...
export default function MeOnline() {
  return (
    <div className="w-full max-w-[15rem] bg-white/70 dark:bg-black/60 rounded-ss-md rounded-ee-md blur-bg text-gray-700 dark:text-gray-300 border border-black/15 dark:border-white/15 h-fit cursor-grab">
