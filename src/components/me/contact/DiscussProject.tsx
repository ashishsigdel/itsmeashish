...
export default function DiscussProject() {
  ...
  return (
    <div className="flex flex-col  my-3 px-3 mx-auto">
      <motion.div
        ref={ref}
        className="rounded-ss-md bg-white dark:bg-black text-hard-dark/80 dark:text-light/80 rounded-ee-md blur-bg border border-black/15 dark:border-white/15 w-full mb-5 mt-5 z-[99]"
        initial={{ opacity: 0, y: 50 }}
        animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
        transition={{ duration: 0.5 }}
      >
        <div className="border-b h-fit w-full border-black/15 dark:border-white/15">
